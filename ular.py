...
class Snake(Frame):
    ...
    def __init__(self):
        ...
        self.master.title("main ular by Vicky Wsa")
        self.grid()
    ...
    def new_game(self):
        ...
        rect1 = self.canvas.create_rectangle(WIDTH/2-rectWidth/2, HEIGHT/2-rectWidth/2,
                                             WIDTH/2+rectWidth/2, HEIGHT/2+rectWidth/2, outline="#dbf", fill="#dbf", tag="rect1")
        rect2 = self.canvas.create_rectangle(WIDTH/2-rectWidth/2, HEIGHT/2-rectWidth/2,
                                             WIDTH/2+rectWidth/2, HEIGHT/2+rectWidth/2, outline="#dbf", fill="#dbf", tag="rect2")
        rect3 = self.canvas.create_rectangle(WIDTH/2-rectWidth/2, HEIGHT/2-rectWidth/2,
                                             WIDTH/2+rectWidth/2, HEIGHT/2+rectWidth/2, outline="#dbf", fill="#dbf", tag="rect3")
    ...
    def make_new_dot(self):
        ...
        self.dot = self.canvas.create_rectangle(
            dotX, dotY, dotX+self.rectWidth, dotY+self.rectWidth, outline="#ddd", fill="#ddd", tag="dot")
    ...
    def check_collide(self):
        ...
        overlapping = self.canvas.find_overlapping(
            frontCoords[0], frontCoords[1], frontCoords[2], frontCoords[3])
    ...
    def end_game(self):
        ...
        if self.score > self.high_score:
            ...
            self.canvas.create_text(
                WIDTH/2, HEIGHT/2+20, text="wew.... Kamu mendapatkan Score tinggi baru!")
